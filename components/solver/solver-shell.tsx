...
/** Iteration limits — integrated solver, always available. */
const ITER_LIMITS: Record<string, number> = {
  kuhn: 50_000,
  leduc: 1_000,
  nlhe_subgame: 100,
};
          ...
          <div className="lg:hidden">
            <Sheet open={mobileConfigOpen} onOpenChange={setMobileConfigOpen}>
              ...
              <SheetContent side="left" className="w-80 overflow-y-auto">
                ...
                <div className="mt-4">
                  <ConfigPanel onSolve={handleSolve} isSolving={isSolving} iterLimits={ITER_LIMITS} />
                </div>
              </SheetContent>
            </Sheet>
          </div>
